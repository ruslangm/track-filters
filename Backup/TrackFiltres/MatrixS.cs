...
namespace TrackFiltres
{
    public class MatrixS
    {
        ...
        public static MatrixS SubsForth(MatrixS A, MatrixS b)          // Function solves Ax = b for A as a lower triangular matrix
        {
        ...
        public static MatrixS SubsBack(MatrixS A, MatrixS b)           // Function solves Ax = b for A as an upper triangular matrix
        {
            if (A.L == null) A.MakeLU();
            int n = A.rows;
            MatrixS x = new MatrixS(n, 1);
        ...
        private static void StrassenMultiplyRun(MatrixS A, MatrixS B, MatrixS C, int l, MatrixS[,] f)    // A * B into C, level of recursion, matrix field
        {
            int size = A.rows;
            int h = size / 2;
